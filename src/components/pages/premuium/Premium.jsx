...
const PremiumModal = ({ onClose = () => {} }) => {
  ...
  const handleBuy = async () => {
    ...
    try {
      // ✅ FAQAT createPremiumOrder ishlatiladi (ichida premium.php chaqiriladi)
...
💰 Oldingi balans: ${result.balance_before?.toLocaleString() || "—"} UZS
💳 Yangi balans: ${result.balance_after?.toLocaleString() || "—"} UZS
📅 Sana: ${result.date || new Date().toLocaleString()}`,
      });
